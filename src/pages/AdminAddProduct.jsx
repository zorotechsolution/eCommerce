      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-10 text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-5">
          ...
          <div className="flex gap-3 flex-wrap">
             ...
             <Link to="/admin/add-product" className="inline-flex items-center gap-2 bg-[rgb(7,81,89)] text-white px-4 py-2 rounded-full font-bold text-sm tracking-wide shadow">
               <FaPlus /> Add New
             </Link>
          </div>
        </div>
